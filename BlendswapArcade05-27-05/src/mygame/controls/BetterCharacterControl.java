...
*/
    ...
    private Vector3f tempWalkDirection = new Vector3f(0, 0, 0);
    private Vector3f tempViewDirection = new Vector3f(0, 0, 1);
...
* @param mass
*/
    public BetterCharacterControl(float radius, float height, float mass, Spatial m) {
        this.radius = radius;
        this.height = height;
        this.mass = mass;
...
*/
    public void physicsTick(PhysicsSpace space, float tpf) {
        ...
        Vector3f modelForwardDir = model.getWorldRotation().mult(Vector3f.UNIT_Z);
        Vector3f modelLeftDir = model.getWorldRotation().mult(Vector3f.UNIT_X);
...
*/
    ...
    /**
     * Sets the directions for the guy to walk
     * 
     * 
     * 
     * 
...
*/
    ...
    public Control cloneForSpatial(Spatial spatial) {
        BetterCharacterControl control = new BetterCharacterControl(radius, height, mass, model);
